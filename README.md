# Portfolio 2026 - Ahmad AL-Fatih Ramadhan

Modern, Interactive & Mobile Responsive Personal Portfolio website featuring a sleek dark-violet aesthetic inspired by modern creative UI design.
...
- Modern CSS (Custom Properties, Dark Glassmorphism, CSS Grid, Flexbox, Fluid Typography, Micro-interactions)
- Vanilla JavaScript (Dynamic Typewriter, Interactive Vector Waves Canvas, Project Filters, Copy to Clipboard, WhatsApp Integration)
- Font Awesome 6 & Google Fonts (Outfit, Plus Jakarta Sans, JetBrains Mono)
